...
public static class RankingSaveSystem
{
    ...
    /// <param name="clearTimeList"></param>
    public void SaveRankingData(List<UserRankData> damageList , List<UserRankData> clearTimeList)
    {
    ...
    public static LoaclMailDataWrapper LoadRankingData()
    {
        if(!PlayerPrefs.HasKey(Save_Key))
        {
            return new LoaclMailDataWrapper(); // 저장 데이터가 없으면 새 객체가 반환
        }
